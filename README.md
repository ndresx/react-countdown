...
As part of a small web app at first, the idea was to separate it from its main package to combine general aspects of the development with React, testing with Jest and more that relates to publishing a new Open Source project.
